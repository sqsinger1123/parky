        ...
        <div class="well">
          <div class="row-fluid" id="top_well_inner">
            <div class="span3" id="logo_signin">
              ...
              <form id="signin" action="/browse/confirm" method="post">
				<div class="span3">
					<label class="control-label">Username</label>
					<div class="controls">
					  <input type="text" class="input-medium input-block-level" name="Username"> 
					</div>
				</div>
				<div class="span3">
					<label class="control-label">Password</label>
					<div class="controls">
					  <input type="password" class="input-medium input-block-level" name="Password">
					</div>
				</div>
				<div class="span3">
				    <br/>

...
<div class="filtermenu">
        <div class="aligncenter">
          Use the area below edit your existing post. Your information is <span class="orange">safe</span> and <span class="orange">secure</span>.
        </div>
      </div>
<div class="row-fluid">
  <div class="span4 offset4">
    <div class="profilemap pl10 pr10 pb10">
          ...
          <?php echo $this->Form->input('instructions', array('label' => 'Instructions for Drivers', 'class' => 'span12', 'placeholder' => 'E.g. Park next to the rosebushes', 'rows' => '3'));?>
            ...
            <h4><?php echo $this->Form->button('Edit Post', array('type' => 'submit', 'class' => 'mt20 btn btn-primary btn-large btn-block'));?></h4>
